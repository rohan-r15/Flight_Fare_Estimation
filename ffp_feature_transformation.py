...
file_handler = logging.FileHandler('feature_transformation_log_file.log')
...
def transform_feature(user_input):
  ...
  logger.info(f'User Input is received : {user_input}')
  user_input.pop('submit')
  logger.info('Feature Transfomation is in Progress...')
  ...
  logger.info('Feature Transformation is Done and It has been sent.')
